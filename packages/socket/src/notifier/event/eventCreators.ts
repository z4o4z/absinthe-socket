import type { AbortEvent, CancelEvent, ErrorEvent, Notifier, ResultEvent, StartEvent } from '../types';
import { EventName } from './constants';

export const createStartEvent = <Payload extends Notifier<any, any>>(payload: Payload): StartEvent<Payload> => ({
