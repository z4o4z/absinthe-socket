...
const removeObserver = <Result, Variables extends void | EmptyObject>(observers: ReadonlyArray<Observer<Result, Variables>>, observer: Observer<Result, Variables>): ReadonlyArray<Observer<Result, Variables>> => {
